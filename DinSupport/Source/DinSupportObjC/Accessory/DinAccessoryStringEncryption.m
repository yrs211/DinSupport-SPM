//
//  DinAccessoryStringEncryption.m
//  DinSupport
//
//  Created by Jin on 2021/4/24.
//

// from http://www.wuleilei.com/

#import "DinAccessoryStringEncryption.h"
#import "NSData+Base64.h"

#define kEncryptKey     @"dinsafe2014     "
#define kIVKey          @"G3kC75PzNRMHjq9F"
...
@implementation DinAccessoryStringEncryption

enum {
    /* options for block ciphers */
    kSCAOptionPKCS5Padding   = 0x0000,
    kSCAOptionPKCS7Padding   = 0x0001,
    kSCAOptionECBMode        = 0x0002
    /* stream ciphers currently have no options */
};

CCOptions _diPpadding = kSCAOptionPKCS5Padding;
